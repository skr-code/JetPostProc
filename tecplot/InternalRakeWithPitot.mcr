...
$!READDATASET  '"STANDARDSYNTAX" "1.0" "FILELIST_CGNSFILES" "1" "/home/sal/Desktop/CDNozzle1.47/ICDSV2/M2/p1/sol/merged_sol_aver.cgns" "LoadBCs" "Yes" "AssignStrandIDs" "Yes" "UniformGridStructure" "Yes" "LoaderVersion" "V3" "CgnsLibraryVersion" "3.3.0"'
  ...
  VARLOADMODE = BYNAME
$!READSTYLESHEET  "/home/sal/Desktop/JetPostProc/tecplot/M2_XVelocityMidPlane.sty"
...
$!EXTENDEDCOMMAND 
  ...
  COMMAND = 'XSTART = -0.182118 YSTART = 0 ZSTART = 0 XEND = 0 YEND = 0 ZEND = 0 NUMPTS = 1000 EXTRACTTHROUGHVOLUME = T EXTRACTTOFILE = T EXTRACTFILENAME = \'/home/sal/Desktop/CDNozzle1.47/ICDSV2/M2/p0-copy/post-proc/internalcenterline.dat\' '
$!EXTENDEDCOMMAND 
  COMMANDPROCESSORID = 'Extract Precise Line'
  COMMAND = 'XSTART = -0.182118 YSTART = 0.0145694 ZSTART = 0 XEND = 0 YEND = 0.0145694 ZEND = 0 NUMPTS = 1000 EXTRACTTHROUGHVOLUME = T EXTRACTTOFILE = T EXTRACTFILENAME = \'/home/sal/Desktop/CDNozzle1.47/ICDSV2/M2/p0-copy/post-proc/internal0point2D.dat\' '
$!EXTENDEDCOMMAND 
  COMMANDPROCESSORID = 'Extract Precise Line'
  COMMAND = 'XSTART = -0.182118 YSTART = 0.0291389 ZSTART = 0 XEND = 0 YEND = 0.0291389 ZEND = 0 NUMPTS = 1000 EXTRACTTHROUGHVOLUME = T EXTRACTTOFILE = T EXTRACTFILENAME = \'/home/sal/Desktop/CDNozzle1.47/ICDSV2/M2/p0-copy/post-proc/internal0point4D.dat\' '
$!RemoveVar |MFBD|
