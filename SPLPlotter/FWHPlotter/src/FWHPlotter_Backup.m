...
%Range For PSI90
%RANGE FOR WATERFALL IS TUCKED AT THE BOTTOM OF SCRIPT
xlimmin = 10^(-2);
xlimmax = 2;
ylimmin = 80;
ylimmax = 120;
...
hold on
if waterfall == 1
    %Override the user input plot limits if we are using a waterfall
    %Range For Waterfall
    xlimmin = 10^(-2);
    xlimmax = 10^1;
    ylimmin = -250;
...
if Plot90 == 1 && IsSecondSimulation == 1;
    ...
    if IsSecondSimulation == 1
        SPLfile = strcat('../FiguresOutput/FWH90°_52D_',SimulationTitle1,'Vs',SimulationTitle2,'.png');
    else
        SPLfile = strcat('../FiguresOutput/FWH90°_52D_',SimulationTitle1,'.png');
    end
    saveas(gcf,SPLfile)
end
if Plot150 == 1 && IsSecondSimulation == 1;
    ...
    legend('Liu-LES-150°-NoSlip','Liu-LES-150°-WallFunc',SimulationTitle1,SimulationTitle2,'Location','best')
     ...
     %Setting up the export
    if IsSecondSimulation == 1
        SPLfile = strcat('../FiguresOutput/FWH150°_52D_',SimulationTitle1,'Vs',SimulationTitle2,'.png');
    else
        SPLfile = strcat('../FiguresOutput/FWH150°_52D_',SimulationTitle1,'.png');
    end
    saveas(gcf,SPLfile)
end
if Plot90 == 1 && Plot150 == 1
    ...
    legend('Liu-LES-90°-NoSlip','Liu-LES-90°-WallFunc','Liu-LES-150°-NoSlip','Liu-LES-150°-WallFunc',SimulationTitle1,SimulationTitle2,'Location','best')
     ...
     %Setting up the export
    if IsSecondSimulation == 1
        SPLfile = strcat('../FiguresOutput/FWHWaterfall_52D_',SimulationTitle1,'Vs',SimulationTitle2,'.png');
    else
        SPLfile = strcat('../FiguresOutput/FWHwaterfall_52D_',SimulationTitle1,'.png');
    end
    saveas(gcf,SPLfile)
end
if Plot90 ~= 1 && Plot150 ~= 1
    ...
    if waterfall == 1
        if IsSecondSimulation == 1
            SPLfile = strcat('../FiguresOutput/Waterfall_52D_',SimulationTitle1,'Vs',SimulationTitle2,'.png');
        else
            SPLfile = strcat('../FiguresOutput/Waterfall_52D_',SimulationTitle1,'.png');
        end
        saveas(gcf,SPLfile)
    else
        if IsSecondSimulation == 1
            SPLfile = strcat('../FiguresOutput/CustomPoint_52D_',SimulationTitle1,'Vs',SimulationTitle2,'.png');
        else
            SPLfile = strcat('../FiguresOutput/CustomPoint_52D_',SimulationTitle1,'.png');
        end
        saveas(gcf,SPLfile)
    end
end
