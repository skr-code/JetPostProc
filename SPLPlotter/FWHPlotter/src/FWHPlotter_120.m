...
if Plot90 ~= 1 && Plot150 ~= 1
    ...
    if waterfall == 1
        ...
        if IsSecondSimulation == 1
            SPLfile = strcat('../FiguresOutput/120deg_52D_',SimulationTitle1,'Vs',SimulationTitle2,'.png');
        else
            SPLfile = strcat('../FiguresOutput/120deg_52D_',SimulationTitle1,'.png');
        end
        saveas(gcf,SPLfile)
    end
end
