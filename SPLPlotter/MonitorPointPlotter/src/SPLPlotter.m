...
if IsSecondSimulation == 1
    SPLfile = strcat('../FiguresOutput/SPL_Point0_',SimulationTitle1,'Vs',SimulationTitle2,'.png');
else
    SPLfile = strcat('../FiguresOutput/SPL_Point0_',SimulationTitle1,'.png');
end
saveas(gcf,SPLfile)
...
if numofmonpoints == 2
    ...
    if IsSecondSimulation == 1
    SPLfile = strcat('../FiguresOutput/SPL_Point1_',SimulationTitle1,'Vs',SimulationTitle2,'.png');
    else
        SPLfile = strcat('../FiguresOutput/SPL_Point1_',SimulationTitle1,'.png');
    end
    saveas(gcf,SPLfile)
end