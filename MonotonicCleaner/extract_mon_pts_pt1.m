...
index = {1}; %Monitor point number that you would like to be read in 
names = {'pt1'}; %Monitor point number that you would like to be outputted
nameMap = containers.Map(index, names);

for index_pt = 1;   %Monitor point number that you would like to be read in
