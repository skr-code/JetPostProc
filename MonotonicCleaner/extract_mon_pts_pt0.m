...
index = {0}; %Monitor point number that you would like to be read in 
names = {'pt0'}; %Monitor point number that you would like to be outputted
nameMap = containers.Map(index, names);

for index_pt = 0;   %Monitor point number that you would like to be read in
